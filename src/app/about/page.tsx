      ...
      <section className="mb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {team.map((member) => (
            <div
              key={member.name}
              className="bg-[#141414] border border-[#c9a84c]/10 overflow-hidden hover:border-[#c9a84c]/30 transition-colors"
            >
              ...
              <div className="p-5 text-center">
                ...
                <p className="text-sm text-[#999] mt-3 whitespace-pre-line">
                  {member.role}
                </p>
              </div>
            </div>
